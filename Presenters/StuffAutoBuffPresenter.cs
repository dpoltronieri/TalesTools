...
{
    public class StuffAutoBuffPresenter
    {
        private IStuffAutoBuffView view;
        private AutoBuffStuff model;

        public StuffAutoBuffPresenter(IStuffAutoBuffView view, AutoBuffStuff model)
        {
            this.view = view;
            this.model = model;
            BindEvents();
        ...
        public void UpdateModel(AutoBuffStuff newModel)
        {
            this.model = newModel;
            UpdateView();
        }
